...
export function downloadWorkerTemplate() {
  const data = [
    ['사번', '이름', '주력공정', '겸직공정(쉼표구분)', '근무요일(쉼표구분)', '기본근무시간(h)', '잔업가능시간(h)', '비고'],
    ['EMP-001', '김철수', '용접', '레이저', '월,화,수,목,금', 8, 2, ''],
    ['EMP-002', '이영희', '레이저', '절곡', '월,화,수,목,금', 8, 0, ''],
    ['EMP-003', '박민준', '도장', '', '월,화,수,목,금', 8, 0, ''],
    ['EMP-004', '정수진', '랜딩도어조립', '절곡,태핑', '월,화,수,목,금', 8, 0, ''],
    ['EMP-005', '최민호', '레이저', '용접', '월,화,수,목', 8, 4, '목요일까지 근무'],
    ['EMP-006', '강지원', '절곡', '레이저,태핑', '월,화,수,목,금', 8, 0, ''],
  ]
...
export function downloadRouteTemplate() {
  const data = [
    ['제품코드', '품명', '규격', '공정순서', '공정명', 'EA당시간(h)', '셋업시간(h)', '인원', '설비'],
    ['4UF0062*A', 'SILL SUPPORT', 'T4.5*60*109 W', 1, '레이저', 0.5, 0.5, 1, '파이버 레이저 #1'],
    ['4UF0062*A', 'SILL SUPPORT', 'T4.5*60*109 W', 2, '절곡', 0.3, 0.3, 1, 'CNC 벤딩 #1'],
    ['4UF0062*A', 'SILL SUPPORT', 'T4.5*60*109 W', 3, '태핑', 0.2, 0.2, 1, '태핑 머신'],
    ['4UF0062*A', 'SILL SUPPORT', 'T4.5*60*109 W', 4, '포장', 0.1, 0, 1, '—'],
    ['3HH-001B', 'HH-프레임 ASSY', 'T3.2 SS400', 1, '레이저', 0.8, 0.5, 1, '파이버 레이저 #2'],
    ['3HH-001B', 'HH-프레임 ASSY', 'T3.2 SS400', 2, '용접', 1.5, 0.5, 2, 'CO2 용접 #1'],
    ['3HH-001B', 'HH-프레임 ASSY', 'T3.2 SS400', 3, '도장', 0.5, 1.0, 1, '도장 부스 #1'],
    ['3HH-001B', 'HH-프레임 ASSY', 'T3.2 SS400', 4, '랜딩도어조립', 0.8, 0.3, 2, '—'],
  ]
