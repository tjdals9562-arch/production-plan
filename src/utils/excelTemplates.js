...
export function downloadRouteTemplate() {
  const data = [
    ['제품코드', '품명', '규격', '공정순서', '공정명', '작업구분', 'EA당시간(h)', '셋업시간(h)', '인원', '설비'],
    ['4UF0062*A', 'SILL SUPPORT', 'T4.5*60*109 W', 1, '레이저', '제관반', 0.5, 0.5, 1, '파이버 레이저 #1'],
    ['4UF0062*A', 'SILL SUPPORT', 'T4.5*60*109 W', 2, '절곡', '제관반', 0.3, 0.3, 1, 'CNC 벤딩 #1'],
    ['4UF0062*A', 'SILL SUPPORT', 'T4.5*60*109 W', 3, '태핑', '제관반', 0.2, 0.2, 1, '태핑 머신'],
    ['4UF0062*A', 'SILL SUPPORT', 'T4.5*60*109 W', 4, '포장', '제관반', 0.1, 0, 1, '—'],
    ['3HH-001B', 'HH-프레임 ASSY', 'T3.2 SS400', 1, '레이저', '제관반', 0.8, 0.5, 1, '파이버 레이저 #2'],
    ['3HH-001B', 'HH-프레임 ASSY', 'T3.2 SS400', 2, '용접', '제관반', 1.5, 0.5, 2, 'CO2 용접 #1'],
    ['3HH-001B', 'HH-프레임 ASSY', 'T3.2 SS400', 3, '도장', '제관반', 0.5, 1.0, 1, '도장 부스 #1'],
    ['3HH-001B', 'HH-프레임 ASSY', 'T3.2 SS400', 4, '랜딩도어조립', '조립반', 0.8, 0.3, 2, '—'],
  ]
